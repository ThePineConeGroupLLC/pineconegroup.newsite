              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input name="name" required className="w-full border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#0fb8ce] transition-colors bg-gray-900 text-white placeholder-gray-500" placeholder="Your full name" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold mb-2">Email Address *</label>
                    <input name="email" type="email" required className="w-full border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#0fb8ce] transition-colors bg-gray-900 text-white placeholder-gray-500" placeholder="you@company.com" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-semibold mb-2">Company / Brand *</label>
                    <input name="company" required className="w-full border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#0fb8ce] transition-colors bg-gray-900 text-white placeholder-gray-500" placeholder="Your company name" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold mb-2">Website URL</label>
                    <input name="website" className="w-full border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#0fb8ce] transition-colors bg-gray-900 text-white placeholder-gray-500" placeholder="https://yoursite.com" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-semibold mb-2">Phone Number</label>
                    <input name="phone" className="w-full border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#0fb8ce] transition-colors bg-gray-900 text-white placeholder-gray-500" placeholder="Your phone number" />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold mb-2">Primary Interest</label>
                    <select name="interest" className="w-full border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#0fb8ce] transition-colors bg-gray-900 text-white placeholder-gray-500 bg-gray-900">
                ...
                <div>
                  ...
                  <select name="budget" className="w-full border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#0fb8ce] transition-colors bg-gray-900 text-white placeholder-gray-500 bg-gray-900">
                ...
                <div>
                  ...
                  <textarea name="message" required rows={5} className="w-full border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#0fb8ce] transition-colors bg-gray-900 text-white placeholder-gray-500 resize-none" placeholder="What are you looking to achieve? What challenges are you facing?" />
                </div>
